    ...
    <>
      ...
      <div className="bg-white font-[family-name:var(--font-urbanist)] text-gray-800 min-h-screen">
        <HeroBanner title="Apartment & Real Estate Security Solutions" />
         ...
         <div className="flex flex-col md:flex-row gap-4 md:gap-6 mx-auto px-4 sm:px-6 max-w-7xl">
          {/* Sidebar - Desktop */}
          <motion.div
          ...
          >
            <motion.img
              src="https://res.cloudinary.com/dggsp8ihg/image/upload/v1748621124/solution_for_apartment_01_xwh0s6.jpg"
            ...
            <div className="prose prose-sm sm:prose lg:prose-lg xl:prose-xl max-w-none">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
                Comprehensive Security Solutions for Apartments & Real Estate
              </h1>
