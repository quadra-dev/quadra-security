...
const SolutionsPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Hotels & Resorts Security Solutions | Quadra Security</title>
        <meta
          name="description"
          content="Protect your hotels and resorts with Quadra Security’s advanced surveillance and AI-powered security solutions for 24/7 safety and peace of mind."
        />
        <Canonical />
      </Head>

      <div className="bg-white font-[family-name:var(--font-urbanist)] text-gray-800 min-h-screen">
        <HeroBanner title="Hotels/Resorts Security" />
          ...
          >
            ...
            <div className="prose prose-sm sm:prose lg:prose-lg xl:prose-xl max-w-none">
              ...
              <p className="text-lg sm:text-xl text-gray-700 mb-8">
                ...
                surveillance systems combine{" "}
                <strong>AI-powered analytics</strong>, high-definition
                monitoring, and smart access control to protect every corner of
                your property - from high-rise apartments to gated communities
              ...
              <div className="mb-12">
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    ...
                    <li>
                      <strong>Anti-tailgating detection</strong> with AI
                      analytics
                    </li>
                    <li>
