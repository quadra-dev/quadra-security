    ...
    <ImagesSlider className="h-screen" images={images}>
      ...
      >
        ...
        <motion.p className="font-bold text-xl md:text-6xl text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 py-4">
          Providing the best CCTV <br /> and Security <span className="text-amber-400">Solutions</span> <br/> in Gurgaon .
        </motion.p>
        {/* <button className="px-4 py-2 backdrop-blur-sm border bg-emerald-300/10 border-emerald-500/20 text-white mx-auto text-center rounded-full relative mt-4">
          <span>Join now →</span>
          <div className="absolute inset-x-0  h-px -bottom-px bg-gradient-to-r w-3/4 mx-auto from-transparent via-emerald-500 to-transparent" />
        </button> */}
        <button className="hover:bg-amber-500 duration-500 cursor-pointer py-3 bg-amber-400 px-8 rounded-3xl shadow-md">
          Book a consultation
        </button>
      </motion.div>
    </ImagesSlider>
